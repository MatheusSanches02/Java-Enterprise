...
//				uno.setVelocidade(70);
				...
				System.out.println(uno.validaAno()?"Ano correto":"Ano inválido");
				...
				System.out.println(ferrari.validaAno()?"Ano correto":"Ano inválido");
				
				//CarroEsportivo esporte = new Carro("Gol", 2010, 100); Não compila!
