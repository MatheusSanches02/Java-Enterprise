...
public class TesteColecoes {
	...
	public static void main(String[] args) {
		...
		conjunto.add(masseratti); //elemento repetido, conjunto nao permite repetição
		...
		//ao adicionar o valor em uma chave existente, o valor antigo é substituido
		
		
		//Recuperar o carro no mapa através da chave
